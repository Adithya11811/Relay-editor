...
import { PostCreationRequest, PostValidator } from '@/lib/validitors/post'
...
export const Editor: React.FC<EditorProps> = ({ subredditId }) => {
  ...
  return (
    <div className="w-full flex flex-col gap-2">
      <div className="w-full p-4 bg-gray-700 rounded-lg border">
        <form
        ...
        >
          <div className="prose prose-stone dark:prose-invert">
            <TextareaAutosize
              ...
              {...rest}
              placeholder="Title"
              className="w-full text-black resize-none appearance-none overflow-hidden bg-transparent text-5xl font-bold focus:outline-none"
            />
